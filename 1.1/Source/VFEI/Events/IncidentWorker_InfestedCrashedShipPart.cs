...
namespace VFEI
{
    class IncidentWorker_InfestedCrashedShipPart : IncidentWorker
    {
        ...
        {
            ThingDef infestedShipPartIncoming = ThingDefsVFEI.VFEI_InfestedShipPartIncoming;
        ...
        {
            SkyfallerMaker.SpawnSkyfaller(ThingDefsVFEI.VFEI_InfestedShipPartIncoming, ThingDefsVFEI.VFEI_InfestedCrashedShipPart, pos, map);
        }
